...
const mergedClickFocusExpectedCode = readTestContent(
  'PuppeteerTestGenerator-MergedClickFocus.unused.js'
);
const mergedClickBlurExpectedCode = readTestContent(
  'PuppeteerTestGenerator-MergedClickBlur.unused.js'
);
const dynamicallyAddedButtonExpectedCode = readTestContent(
  'PuppeteerTestGenerator-DynamicallyAddedButton.unused.js'
);
const removedTextNodeExpectedCode = readTestContent(
  'PuppeteerTestGenerator-RemovedTextNode.unused.js'
);
const removedElementExpectedCode = readTestContent(
  'PuppeteerTestGenerator-RemovedElement.unused.js'
);

const inputExpectedCode = readTestContent('PuppeteerTestGenerator-Input.unused.js');
const inputNumberExpectedCode = readTestContent('PuppeteerTestGenerator-InputNumber.unused.js');
const buttonExpectedCode = readTestContent('PuppeteerTestGenerator-Button.unused.js');
const buttonMousedownExpectedCode = readTestContent(
  'PuppeteerTestGenerator-ButtonMousedown.unused.js'
);
const buttonComplexExpectedCode = readTestContent('PuppeteerTestGenerator-ButtonComplex.unused.js');
const textareaExpectedCode = readTestContent('PuppeteerTestGenerator-Textarea.unused.js');
const inputAndButtonExpectedCode = readTestContent(
  'PuppeteerTestGenerator-InputButtonSpan.unused.js'
);
const loginFormExpectedCode = readTestContent('PuppeteerTestGenerator-LoginForm.unused.js');
const inputEnhancedExpectedCode = readTestContent('PuppeteerTestGenerator-InputEnhanced.unused.js');
const inputKeyEventsExpectedCode = readTestContent(
  'PuppeteerTestGenerator-InputKeyEvents.unused.js'
);
const inputCheckboxExpectedCode = readTestContent('PuppeteerTestGenerator-InputCheckbox.unused.js');
const inputRadioExpectedCode = readTestContent('PuppeteerTestGenerator-InputRadio.unused.js');

const asyncKeydownExpectedCode = readTestContent('PuppeteerTestGenerator-AsyncKeydown.unused.js');
const asyncButtonExpectedCode = readTestContent('PuppeteerTestGenerator-AsyncButton.unused.js');
const asyncButtonTwoClicksExpectedCode = readTestContent(
  'PuppeteerTestGenerator-AsyncButton__TwoClicks.unused.js'
);
const asyncRequestOnMountExpectedCode = readTestContent(
  'PuppeteerTestGenerator-AsyncRequestOnMount.unused.js'
);
const asyncButtonTwoRequestsOnClickExpectedCode = readTestContent(
  'PuppeteerTestGenerator-AsyncButtonTwoRequestsOnClick.unused.js'
);
const asyncButtonTwoRequestsOneByOneExpectedCode = readTestContent(
  'PuppeteerTestGenerator-AsyncButtonTwoRequestsOneByOne.unused.js'
);
const asyncButtonComplexExpectedCode = readTestContent(
  'PuppeteerTestGenerator-AsyncButtonComplex.unused.js'
);

const asyncFormExpectedCode = readTestContent('PuppeteerTestGenerator-AsyncForm.unused.js');

const asyncInputSlowTypingsExpectedCode = readTestContent(
  'PuppeteerTestGenerator-AsyncInputSlowTypings.unused.js'
);

const delayedButtonExpectedCode = readTestContent('PuppeteerTestGenerator-DelayedButton.unused.js');
const nestedDivInsideDivExpectedCode = readTestContent(
  'PuppeteerTestGenerator-NestedDivInsideDiv.unused.js'
);

const nestedInputInsideDivExpectedCode = readTestContent(
  'PuppeteerTestGenerator-NestedInputInsideDiv.unused.js'
);

const nestedComplexComponentExpectedCode = readTestContent(
  'PuppeteerTestGenerator-NestedComplexComponent.unused.js'
);

const childListMutationExpectedCode = readTestContent(
  'PuppeteerTestGenerator-ChildListMutation.unused.js'
);

const selectExpectedCode = readTestContent('PuppeteerTestGenerator-Select.unused.js');
const selectMissClickExpectedCode = readTestContent(
  'PuppeteerTestGenerator-SelectMissClick.unused.js'
);

const registrationFormExpectedCode = readTestContent(
  'PuppeteerTestGenerator-RegistrationForm.unused.js'
);

const registrationFormFirstSubmitFailureExpectedCode = readTestContent(
  'PuppeteerTestGenerator-RegistrationFormFirstSubmitFailure.unused.js'
);

const todoListExpectedCode = readTestContent('PuppeteerTestGenerator-TodoList.unused.js');

describe('PuppeteerTestGenerator', () => {
  describe('transformDataAndGenerateCode', () => {
